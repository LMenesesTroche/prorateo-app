...
import { Droplet, Zap, BarChart3, LineChart, ArrowRight } from "lucide-react";

export const WaterIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
    {/* Simple rounded droplet shape */}
...
export default function Landing() {
  ...
  before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_20%_30%,rgba(59,130,246,0.08),transparent_40%)]
  after:absolute after:inset-0 after:bg-[radial-gradient(circle_at_80%_70%,rgba(14,165,233,0.06),transparent_40%)]"
    >
      {/* subtle noise texture */}
      <div className="pointer-events-none absolute inset-0 opacity-[0.03] bg-[url('/noise.png')]"></div>{" "}
      {/* HEADER */}
      ...
      <div className="w-full max-w-5xl bg-white/70 backdrop-blur-lg p-6 rounded-3xl shadow-xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Link
            href="/agua"
            className="group flex items-center justify-between p-6 rounded-2xl bg-blue-50 hover:bg-blue-100 transition shadow-sm"
          >
          ...
          <Link
            href="/luz"
            className="group flex items-center justify-between p-6 rounded-2xl bg-yellow-50 hover:bg-yellow-100 transition shadow-sm"
          >
            <div className="flex items-center gap-4">
          ...
          <Link
            href="/historial-agua"
            className="group flex items-center justify-between p-6 rounded-2xl bg-cyan-50 hover:bg-cyan-100 transition shadow-sm"
          >
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 flex items-center justify-center rounded-full bg-blue-200">
          ...
          <Link
            href="/historial-luz"
            className="group flex items-center justify-between p-6 rounded-2xl bg-orange-50 hover:bg-orange-100 transition shadow-sm"
          >
            <div className="flex items-center gap-4">
